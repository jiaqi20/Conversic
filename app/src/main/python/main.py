...
#path = "/storage/emulated/0/Download/template/"
#path = os.getcwd()  #get directory of .py files
path = "/data/user/0/com.example.conversic/cache/"
...
note_paths = {
    ...
    "half": [
        path + "half-space.png",
        path + "half-note-line.png",
        path + "half-line.png",
        path + "half-note-space.png"
    ],
    "whole": [
        path + "whole-space.png",
        path + "whole-note-line.png",
        path + "whole-line.png",
        path + "whole-note-space.png"
    ]
}
rest_paths = {
    "eighth": [ path + "eighth_rest.jpg"],
    "quarter": [ path + "quarter_rest.jpg"],
    "half": [ path + "half_rest_1.jpg",
             path + "half_rest_2.jpg"],
    "whole": [ path + "whole_rest.jpg"]
}

flag_paths = [ path + "eighth_flag_1.jpg",
                path + "eighth_flag_2.jpg",
                path + "eighth_flag_3.jpg",
                path + "eighth_flag_4.jpg",
                path + "eighth_flag_5.jpg",
                path + "eighth_flag_6.jpg",
                path + "eighth_flag_7.jpg"]

barline_paths = [ path + "barline_1.jpg",
                  path + "barline_2.jpg",
                  path + "barline_3.jpg",
                  path + "barline_4.jpg",
                  path + "barline_5.png"]
...
# Time Signatures
time_imgs = {
    "common": [cv2.imread(time, 0) for time in [ path + "common.jpg"]],
    "44": [cv2.imread(time, 0) for time in [ path + "time44.jpg", path + "time44_2.png"]],
    "34": [cv2.imread(time, 0) for time in [ path + "time34.jpg"]],
    "24": [cv2.imread(time, 0) for time in [ path + "time24.jpg"]],
    "68": [cv2.imread(time, 0) for time in [ path + "time68.jpg"]]
}
