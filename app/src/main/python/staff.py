...
class Staff(object):
    ...
    def getPitch(self, note_center_y):
        ...
        num = int(self.getLineSpacing() * 4 / 5)
        ...
        elif (note_center_y in list(range(self.line_two[-1] + 1, self.line_two[-1] + num))):
            return clef_info[self.clef][0][3]
        elif (note_center_y in list(range(self.line_two[-1] + num, self.line_three[-1] + 1))):
            return clef_info[self.clef][0][4]
        elif (note_center_y in list(range(self.line_three[-1] + 1, self.line_three[-1] + num))):
            return clef_info[self.clef][0][5]
        elif (note_center_y in list(range(self.line_three[-1] + num, self.line_four[-1]))):
